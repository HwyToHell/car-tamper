...
if ($h -or ($args.Count -eq 0)) {
    "Benutzung: bewegungsanalyse [Option]... [Datum]..."
    " "
    "Bewegungsanalyse für Videodateien vom Raspberry Pi,"
    "die maximal 7 Tage zurückliegen"
    "Datumsangabe: im Format YYYY-MM-DD oder X [entspricht heute minus X Tage]"
    "mehrere Daten durch Leerzeichen trennen"
    " "
    "Beispiele:"
    "    Analyse für 30. Apr 2021 und 1. Mai 2021"
    "    bewegungsanalyse 2021-04-30 2021-05-01"
    " "
    "    Analyse für vorgestern (heute minus 2 Tage)"
    "    bewegungsanalyse 2"
    " "
    "Optionen:"
